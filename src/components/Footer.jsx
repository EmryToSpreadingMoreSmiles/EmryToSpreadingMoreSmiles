...
const Footer = () => {
  return (
    <footer className="w-full bg-[#2774AC] dark:bg-gray-900 text-white pl-5 pr-5 mt-5">
      <div className="mx-auto p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            <a
              href="#"
              class="500 hover:900 dark:hover:text-white"
            >
              <svg
                class="w-4 h-4"
                aria-hidden="true"
            ...
            <a
              href="#"
              class="500 hover:900 dark:hover:text-white ms-5"
            >
              <svg
                class="w-4 h-4"
                aria-hidden="true"
